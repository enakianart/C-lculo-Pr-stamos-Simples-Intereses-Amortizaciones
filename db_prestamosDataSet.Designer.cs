...
namespace Cálculo_Préstamos_Simples__Intereses__Amortizaciones.db_prestamosDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([ClientesId] = @Original_ClientesId) AND ([Nombre] = @Original_Nombre) AND ([Correo] = @Original_Correo) AND ([Telefono] = @Original_Telefono) AND ([Sueldo] = @Original_Sueldo) AND ([Estado] = @Original_Estado) AND ([CantidadMoras] = @Original_CantidadMoras))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nombre], [Correo], [Telefono], [Direccion], [Sueldo], [Garantia], [Estado], [CantidadMoras]) VALUES (@Nombre, @Correo, @Telefono, @Direccion, @Sueldo, @Garantia, @Estado, @CantidadMoras);
...
SELECT ClientesId, Nombre, Correo, Telefono, Direccion, Sueldo, Garantia, Estado, CantidadMoras FROM Clientes WHERE (ClientesId = @ClientesId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClientesId, Nombre, Correo, Telefono, Direccion, Sueldo, Garantia, Estado," +
                " CantidadMoras FROM dbo.Clientes";
        ...
        public virtual int Fill(db_prestamosDataSet.ClientesDataTable dataTable) {
        ...
        public virtual db_prestamosDataSet.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db_prestamosDataSet.ClientesDataTable dataTable = new db_prestamosDataSet.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db_prestamosDataSet.ClientesDataTable dataTable) {
